...
if st.button("VOLTAR", key="b_mt"): st.switch_page("app.py")

st.title("Modelos de Proposta PDF")
servico_sel = st.selectbox("Escolha a categoria", ["CFTV", "Cerca/Concertina", "Motor de Portão"])
...
with st.form("f_text"):
    novo = st.text_area("Descrição detalhada (Benefícios)", value=texto_atual, height=300)
