...
# --- PAINEL HOME (LOGADO) ---
st.markdown("<div style='text-align:center; margin-top:5vh;'><h1 style='font-size:40px; font-weight:800;'>PAINEL VERO</h1><p style='color:#64748b;'>Selecione a operação desejada</p></div>", unsafe_allow_html=True)
